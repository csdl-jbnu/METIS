...
!
! Module - Exam_METIS
! Last Updated : 08/05/2019, by Hyungmin Jun (hyungminjun@outlook.com)
!
! =============================================================================
!
...
module Exam_METIS
    ...
    public Exam_METIS_Star              ! 05. Star
...
! Example of the star
subroutine Exam_METIS_Star(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom

    ! Set problem
    prob.name_prob = "05_Star"
...
end subroutine Exam_METIS_Star
