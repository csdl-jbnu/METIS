...
!
! Module - Para
! Last Updated : 08/01/2019, by Hyungmin Jun (hyungminjun@outlook.com)
!
! =============================================================================
!
...
module Para
    ...
    logical, parameter :: p_ATHENA   = .true.       ! .false.: desiners, .true.: ATHENA output
    character(4)       :: p_color    = "new2"       ! [new1, new2, old] old - group color, new from online
    ...
    logical :: para_write_102   = .true.    ! *target_geometry.bild
    ...
    logical :: para_write_302   = .false.   ! *geometry_local.bild
    logical :: para_write_303   = .true.    ! *separate_lines.bild
    logical :: para_write_401   = .false.   !  cro_geo.bild
    logical :: para_write_501   = .false.   !  cyl_ori.bild
    logical :: para_write_502   = .true.    ! *cylinder_model.bild
    logical :: para_write_503   = .false.   !  mesh.bild
    logical :: para_write_504   = .true.    ! *section_lines.bild
    ...
    logical :: para_write_606   = .true.    ! *spantree.bild
    logical :: para_write_607   = .true.    ! *crossovers.bild
    ...
    logical :: para_write_702   = .true.    ! *atomic_model.bild
    logical :: para_write_703   = .true.    ! *routing_scaf.bild / routing_stap.bild
    logical :: para_write_705   = .true.    ! *routing_model.bild
