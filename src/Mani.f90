...
subroutine Mani_Set_Prob(prob, color)
    ...
    if(prob.sel_edge_sec == 2) char_sec = "6HBi"
    if(prob.sel_edge_sec == 3) char_sec = "6HBm"
    if(prob.sel_edge_sec == 4) char_sec = "10HB"
    if(prob.sel_edge_sec == 5) char_sec = "12HB"
    if(prob.sel_edge_sec == 6) char_sec = "16HB"

    prob.name_file = trim(prob.name_prob)//"_"//trim(char_sec)//"_"//trim(adjustl(trim(char_bp)))//"bp"

    if(p_color == "new1") then
        if(color == 'blue') then
            prob.color      = [ 114, 147, 203 ]; prob.color_atom = [ 114, 147, 203 ]
        else if(color == 'red') then
            prob.color      = [ 211,  94,  96 ]; prob.color_atom = [ 211,  94,  96 ]
        else if(color == 'green') then
            prob.color      = [ 132, 186,  91 ]; prob.color_atom = [ 132, 186,  91 ]
        else if(color == 'yellow') then
            prob.color      = [ 204, 194,  16 ]; prob.color_atom = [ 204, 194,  16 ]
        else if(color == 'violet') then
            prob.color      = [ 144, 103, 167 ]; prob.color_atom = [ 144, 103, 167 ]
        end if
    else if(p_color == "new2") then
        if(color == 'blue') then
            prob.color      = [  57, 106, 177 ]; prob.color_atom = [  57, 106, 177 ]
        else if(color == 'red') then
            prob.color      = [ 204,  37,  41 ]; prob.color_atom = [ 204,  37,  41 ]
        else if(color == 'green') then
            prob.color      = [  62, 150,  81 ]; prob.color_atom = [  62, 150,  81 ]
        else if(color == 'yellow') then
            prob.color      = [ 148, 139,  61 ]; prob.color_atom = [ 148, 139,  61 ]
        else if(color == 'violet') then
            prob.color      = [ 107,  76, 154 ]; prob.color_atom = [ 107,  76, 154 ]
        end if
    else if(p_color == "old") then
        if(color == 'blue') then
            prob.color      = [  52, 152, 219 ]; prob.color_atom = [  52, 152, 219 ]
        else if(color == 'red') then
            prob.color      = [ 231,  76,  60 ]; prob.color_atom = [ 231,  76,  60 ]
        else if(color == 'green') then
            prob.color      = [  77, 175,  74 ]; prob.color_atom = [  77, 175,  74 ]
        else if(color == 'yellow') then
            prob.color      = [ 247, 147,  30 ]; prob.color_atom = [ 247, 147,  30 ]
        else if(color == 'violet') then
            prob.color      = [ 150,  58, 228 ]; prob.color_atom = [ 150,  58, 228 ]
        end if
    end if
